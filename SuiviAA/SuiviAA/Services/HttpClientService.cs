...
namespace SuiviAA.Services
{
    public class HttpClientService : HttpClient
    {
        ...
        {
            string urlActeur = "http://172.16.9.21/ppe3JoJuAd/gsbAppliFraisV2/webservices/w_visiteur.php" + "?" + "login=" + login + "&" + "pass=" + mdp;
        ...
        {
            string urlCabinet = "http://172.16.9.21/ppe3JoJuAd/gsbAppliFraisV2/webservices/w_cabinet.php" + "?" + "user=" + userId;
        ...
        {
            string urlVisite = "http://172.16.9.21/ppe3JoJuAd/gsbAppliFraisV2/webservices/w_visite.php" + "?" + "user=" + userId;
        ...
        {
            string urlMedecin = "http://172.16.9.21/ppe3JoJuAd/gsbAppliFraisV2/webservices/w_medecin.php" + "?" + "user=" + userId;
